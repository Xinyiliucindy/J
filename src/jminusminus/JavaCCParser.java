...
class JavaCCParser implements JavaCCParserConstants {
  ...
  final private JClassDeclaration classDeclaration(ArrayList<String> mods) throws ParseException {
    ...
    try {
      ...
      classBody = classBody();
        ...
        {if (true) return new JClassDeclaration(line, mods, name, superClass, implementedInterfaces, classBody);}
    throw new Error("Missing return statement in function");
  }
      ...
      while (true) {
        ...
        if (jj_2_4(2147483647)) {
          mods = modifiers();
                  line = token.beginLine;
          body = block();
                    aMember = new JInitializationBlock(line, mods, body);
                    members.add(aMember);
  ...
  final private JInterfaceDeclaration interfaceDeclaration(ArrayList<String> mods) throws ParseException {
    ...
    try {
      ...
      {if (true) return new JInterfaceDeclaration(line, mods, name, superInterfaces, interfaceBody);}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JMember interfaceMemberDecl(ArrayList<String> mods) throws ParseException {
    ...
    JAST interfaceDeclaration = null;
    ...
    try {
      if (jj_2_7(2147483647)) {
        ...
        jj_consume_token(SEMI);
                    ...
                    interfaceMember = new JMethodDeclaration(line, mods, name,
        ...
        case IDENTIFIER:
          ...
          jj_consume_token(SEMI);
                    ...
                    interfaceMember = new JFieldDeclaration(line, mods,
                                                    variableDeclarators);
          break;
        default:
          jj_la1[17] = jj_gen;
    ...
    recoverFromError(new int[] { SEMI, EOF }, e);
      ...
      {if (true) return interfaceMember;}
    throw new Error("Missing return statement in function");
  }
        ...
        if (jj_2_10(2147483647)) {
          ...
          if (jj_2_8(2147483647)) {
            ...
            exception = qualifiedIdentifier();
                  exceptionClauses.add(exception);
            label_11:
            while (true) {
              switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
              case COMMA:
          ...
          default:
            ...
            throw new ParseException();
                ...
                memberDecl = new JMethodDeclaration(line, mods, name,
                                                    type, params, exceptionClauses, body);
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case BOOLEAN:
          case CHAR:
  ...
  final private JStatement statement() throws ParseException {
    ...
    //step 3 throw
    JExpression throwExpression = null;
    //for
    ArrayList<JStatement> initfor  = null;
    ArrayList<JStatement> updatefor = null;
    ArrayList<String> mods = new ArrayList<String>();
    Type type = null;
    ArrayList<JVariableDeclarator> vdecls =null;//zhidie
    JFormalParameter init = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LCURLY:
        statement = block();
      ...
      case THROW:
        ...
        jj_consume_token(SEMI);
         statement = new JThrowStatement(line, throwExpression);
        break;
      case IF:
        jj_consume_token(IF);
               line = token.beginLine;
      ...
      default:
        ...
        if (jj_2_14(2147483647)) {
          ...
          body = statement();
          statement = new JForStatement(line,initfor,expr,updatefor,body,"basic");
        } else if (jj_2_15(2147483647)) {
          jj_consume_token(FOR);
                line = token.beginLine;
          jj_consume_token(LPAREN);
          init = formalParameter();
          jj_consume_token(COLON);
          expr = relationalExpression();
          jj_consume_token(RPAREN);
          body = statement();
          statement = new JForStatement(line, init,expr,body,"enhanced");
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case WHILE:
  ...
  final private ArrayList<JStatement> forInit() throws ParseException {
    ...
    ArrayList<JStatement> forInitArray = new ArrayList<JStatement>();
    Type type = null;
    ...
    try {
      if (jj_2_16(2147483647)) {
        ...
        vdecls = variableDeclarators(type);
         forInitArray.add(new JVariableDeclaration(line,vdecls));
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case FALSE:
        case NEW:
  ...
  final private ArrayList<JStatement> forUpdate() throws ParseException {
    ...
    try {
      ...
      {if (true) return forUpdateStatements;}
    throw new Error("Missing return statement in function");
  }
  ...
  final private JTryStatement tryStatement() throws ParseException {
    ...
    JCatchClause aCatchClause = null;
    ...
    try {
      ...
      {if (true) return new JTryStatement(line, tryblock, catchClauses, finallyblock);}
    throw new Error("Missing return statement in function");
  }

  final private JCatchClause catchClause() throws ParseException {
    int line = 0;
    ...
    try {
      ...
      {if (true) return new JCatchClause(line, formalParameter, catchblock);}
    throw new Error("Missing return statement in function");
  }

  final private JCatchFormalParameter catchFormalParameter() throws ParseException {
    int line = 0;
    ArrayList<TypeName> catchTypes = new ArrayList();
    String name = "";
    TypeName aType = null;
    try {
      jj_consume_token(LPAREN);
                   line = token.beginLine;
      aType = qualifiedIdentifier();
    ...
    try {
      ...
      case REM_ASSIGN:
        ...
        case STAR_ASSIGN:
          ...
          rhs = assignmentExpression();
              lhs = new JMultiAssignOp(line, lhs, rhs);
          break;
        case DIV_ASSIGN:
    ...
    try {
      ...
      case QUESTION:
        ...
        condition = conditionalExpression();
              lhs = new JConditionalExpression(line, lhs, condition, assign);
        break;
      default:
        jj_la1[55] = jj_gen;
        ;
  ...
  final private JExpression bitwiseOrExpression() throws ParseException {
    int line = 0;
    JExpression lhs = null, rhs = null;
    try {
      lhs = bitXorExpression();
                                   line = lhs.line();
      label_26:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final private JExpression bitXorExpression() throws ParseException {
    int line = 0;
    JExpression lhs = null, rhs = null;
    try {
      lhs = bitAndExpression();
                                   line = lhs.line();
      label_27:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final private JExpression bitAndExpression() throws ParseException {
    int line = 0;
    JExpression lhs = null, rhs = null;
    try {
  ...
  final private boolean jj_3R_85() {
    if (jj_scan_token(BTOR)) return true;
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x40000000,0x8100,0x8100,0x100,0x100,0x200000,0x0,0x20000000,0x8c300,0x8c300,0x0,0x200000,0x84300,0x84200,0x0,0x0,0x84200,0x8000,0x0,0x84200,0x0,0x0,0x8100,0x84200,0x16084200,0x16000000,0x2084200,0x2000000,0x2000000,0x2000000,0x10000000,0x2000000,0x0,0x2000000,0x0,0x2000,0x800000,0x0,0x0,0x84200,0x0,0x0,0x2000000,0x0,0x2000000,0x0,0x2000000,0x84200,0x84200,0x0,0x0,0x84200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x2000000,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x84200,0x0,0x0,0x0,0x2000000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x40,0x0,0x1382,0x1382,0x1380,0x1380,0x0,0x0,0x0,0x801383,0x801383,0x0,0x0,0x801381,0x800001,0x0,0x0,0x1,0x2,0x0,0x800001,0x0,0x0,0x1382,0x1,0x82664431,0x82664430,0x80424031,0x80424030,0x80424030,0x80424030,0x240000,0x82424430,0x0,0x80424030,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x8000000,0x80424030,0x0,0x80424030,0x0,0x80424030,0x1,0x1,0x0,0x0,0x1,0x8000000,0x8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x10000000,0x20000000,0x20000000,0x4000000,0x4000000,0x0,0x0,0x80424030,0x0,0x424030,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x424030,0x1,0x0,0x0,0x0,0x400020,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000a80,0x40000a80,0x40000a80,0x40000a80,0x40000a80,0x40000a80,0x0,0x40000a80,0x0,0x40000a80,0x0,0x0,0x0,0x4000000,0x0,0x0,0x0,0x0,0x40000a80,0x0,0x40000a80,0x0,0x40000a80,0x0,0x0,0x0,0x0,0x0,0x55400,0x55400,0x20000000,0x10000000,0x4,0x4000000,0x20,0x1,0x0,0x10,0x10,0x200,0x200,0x2a000,0x2a000,0x40000a80,0x80,0x40000000,0x0,0x800,0x800,0x40000000,0x0,0x40000000,0x40000000,0x40000000,0x40000000,0x40000000,0x0,0x0,0x40000000,0x0,0x0,};
   }
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x10,0x10,0x0,0x0,0x0,0x20,0x0,0x101,0x100,0x20,0x0,0x100,0x100,0x4,0x20,0x100,0x0,0x20,0x100,0x20,0x11,0x0,0x100,0x47111,0x47111,0x47100,0x47100,0x47100,0x47100,0x1,0x47110,0x20,0x47100,0x20,0x0,0x0,0x0,0x20,0x100,0x20,0x0,0x47101,0x20,0x47101,0x20,0x47100,0x0,0x0,0x4,0x4,0x100,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x47100,0x0,0x47100,0x44,0x0,0x0,0x0,0x44,0x0,0x0,0x40,0x0,0x47100,0x100,0x1,0x0,0x4,0x47000,};
   }
